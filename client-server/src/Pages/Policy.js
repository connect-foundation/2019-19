    ...
    <StyledContainer>
      ...
      <p className="ls2 lh6 bs5 ts4">
        <em className="emphasis">
          &lt;안봐도비디오&gt;('http://www.abdvideo.ml'이하 '안봐도비디오')
        </em>
      ...
      <p className="ls2 lh6 bs5 ts4">
        <em className="emphasis">&lt;안봐도비디오&gt;('안봐도비디오')</em>{' '}
        은(는) 회사는 개인정보처리방침을 개정하는 경우 웹사이트 공지사항(또는
        개별공지)을 통하여 공지할 것입니다.
      </p>
      <p className="ls2">
        ○ 본 방침은부터 <em className="emphasis">2019</em>년{' '}
        <em className="emphasis">12</em>월 <em className="emphasis">1</em>일부터
        시행됩니다.
      </p>
      <br />
      <p className="lh6 bs4">
      ...
      <br />
      <p className="ls2">나. 민원사무 처리</p>
      <p className="ls2">처리결과 통보 등을 목적으로 개인정보를 처리합니다.</p>
      <br />
      <p className="ls2">다. 재화 또는 서비스 제공</p>
      <p className="ls2">콘텐츠 제공 등을 목적으로 개인정보를 처리합니다.</p>
      <br />
      <p className="ls2">라. 마케팅 및 광고에의 활용</p>
      <p className="ls2">
      ...
      <p className="ls2">
        1. 개인정보 파일명 : 안봐도비디오 개인정보 파일
        <br /> - 개인정보 항목 : 이메일, 로그인ID, 이름
        <br /> - 수집방법 : 홈페이지
        <br /> - 보유근거 : 서비스 제공
        <br /> - 보유기간 : 1년
      ...
      <p className="lh6 bs4">
        ...
        <br />
        <br />①{' '}
        <em className="emphasis">&lt;안봐도비디오&gt;('안봐도비디오')</em>은(는)
        법령에 따른 개인정보 보유·이용기간 또는 정보주체로부터 개인정보를
        수집시에 동의 받은 개인정보 보유,이용기간 내에서 개인정보를
        처리,보유합니다.
        <br />
      ...
      <p className="ls2">
        ① 정보주체는 안봐도비디오에 대해 언제든지 개인정보
        열람,정정,삭제,처리정지 요구 등의 권리를 행사할 수 있습니다.
        <br />② 제1항에 따른 권리 행사는안봐도비디오에 대해 개인정보 보호법
        시행령 제41조제1항에 따라 서면, 전자우편, 모사전송(FAX) 등을 통하여 하실
        수 있으며 안봐도비디오은(는) 이에 대해 지체 없이 조치하겠습니다.
        ...
        <br />⑥ 안봐도비디오은(는) 정보주체 권리에 따른 열람의 요구, 정정·삭제의
      ...
      <p className="ls2">
        ① 안봐도비디오 은 개별적인 맞춤서비스를 제공하기 위해 이용정보를
        ...
        설정을 통해 쿠키 저장을 거부 할 수 있습니다. 다. 쿠키 저장을 거부할 경우
      ...
      <br /> ① 안봐도비디오(‘http://www.abdvideo.ml’이하 ‘안봐도비디오) 은(는)
      ...
      <p className="ls2">
        ...
        직급 :팀원
        <br />
        연락처 :01053762933, wt2933@naver.com, <br />※ 개인정보 보호 담당부서로
        연결됩니다.
        <br /> <br />▶ 개인정보 보호 담당부서
        <br />
        부서명 :<br />
        담당자 :<br />
        연락처 :, , <br />② 정보주체께서는
        안봐도비디오(‘http://www.abdvideo.ml’이하 ‘안봐도비디오) 의 서비스(또는
        사업)을 이용하시면서 발생한 모든 개인정보 보호 관련 문의, 불만처리,
        피해구제 등에 관한 사항을 개인정보 보호책임자 및 담당부서로 문의하실 수
        있습니다. 안봐도비디오(‘http://www.abdvideo.ml’이하 ‘안봐도비디오)
      ...
      <p className="ls2">
        ...
        <br /> 개인정보를 취급하는 직원을 지정하고 담당자에 한정시켜 최소화 하여
        ...
        <br />
        3. 비인가자에 대한 출입 통제
        <br /> 개인정보를 보관하고 있는 물리적 보관 장소를 별도로 두고 이에 대해
