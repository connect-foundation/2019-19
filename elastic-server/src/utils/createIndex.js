  ...
  return client.indices.putMapping({
    ...
    body: {
      ...
      properties: {
        ...
        name_ko: { type: 'text', analyzer: 'korean', search_analyzer: "korean" },
        likes: { type: 'long' },
        reg_date: { type: 'date' },
        ...
        video_id: { type: 'text' },
        //category: { type: 'text', analyzer: 'autocomplete', search_analyzer: "autocomplete" },
        category: { type: 'text', analyzer: 'korean', search_analyzer: "korean" },
        index : {type: 'long'}
      }
    }
  }).then(handleResolve);
